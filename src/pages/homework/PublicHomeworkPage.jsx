          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <button
              ...
              style={{
                ...
                height: '42px',
                padding: '0 16px',
                border: `1px solid ${notifStatus === 'subscribed' ? 'rgba(239,68,68,0.4)' : notifStatus === 'denied' ? 'var(--border-color)' : 'rgba(20,184,166,0.4)'}`,
                borderRadius: '8px',
                background: notifStatus === 'subscribed' ? 'rgba(239,68,68,0.1)' : notifStatus === 'denied' ? 'var(--bg-secondary)' : 'rgba(20,184,166,0.1)',
                color: notifStatus === 'subscribed' ? '#ef4444' : notifStatus === 'denied' ? 'var(--text-muted)' : 'var(--primary)',
